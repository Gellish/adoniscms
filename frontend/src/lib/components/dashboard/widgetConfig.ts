...
export type WidgetData = TableWidgetData | Record<string, any>;
...
export interface PaletteItem {
    ...
    defaultRows: number;
    data?: WidgetData;
    isCustom?: boolean; // Added for Widget Manager
    id?: string; // Custom widgets need an ID
}

export const BASE_WIDGETS: PaletteItem[] = [
    {
        type: "stats",
        label: "Stats Card",
        icon: "📊",
