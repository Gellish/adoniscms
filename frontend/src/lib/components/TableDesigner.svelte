<script lang="ts">
    ...
    import { ClientDB, type TableMeta } from "$lib/client-db/core";
...
<div class="max-w-4xl mx-auto w-full">
    <div class="flex items-center justify-between mb-8">
        <div>
            ...
            <p class="text-gray-400 mt-2 text-sm">
                Define the schema for your offline-first application components.
            </p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <!-- Creation Card -->
        <div
            class="md:col-span-1 bg-white p-6 rounded-2xl shadow-sm border border-gray-200"
        >
            <h2
            ...
            <div class="space-y-6">
                <div>
                    <label
                        class="block text-[10px] font-black text-gray-500 uppercase mb-1.5"
                        for="name">Internal Name</label
                    >
                    <input
                        bind:value={name}
                        id="name"
                ...
                <div>
                    <label
                        class="block text-[10px] font-black text-gray-500 uppercase mb-1.5"
                        for="key">Primary Key Path</label
                    >
                    <input
                        bind:value={keyPath}
                        id="key"
                ...
                >
                    <div>
                        <p
                            class="text-xs font-black text-gray-700 uppercase leading-none"
                        >
                            AES-GCM Encryption
                        </p>
        ...
        <div class="md:col-span-2 space-y-6">
            <div
                class="bg-gray-900 text-white p-8 rounded-2xl shadow-xl border border-gray-800 relative overflow-hidden"
            >
                <div class="relative z-10">
                    <h2
                        class="text-xl font-black uppercase tracking-tighter mb-4"
                    >
                        Production-Ready Architecture
                    </h2>
                    <p class="text-gray-400 text-sm leading-relaxed mb-6">
                        You are using a state-of-the-art ClientDB engine. Every
                        table you create is automatically versioned and tracked
                        in the <span class="text-primary-400 font-mono"
                            >_meta</span
                        > store.
                    </p>
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        >
                            <p
                                class="text-[9px] font-black text-primary-400 uppercase mb-1"
                            >
                                Conflict Strategy
                            </p>
                ...
                <div
                    class="absolute -bottom-10 -right-10 w-48 h-48 bg-primary-600/10 rounded-full blur-3xl"
                ></div>
            </div>

            <div
                class="bg-amber-50 border border-amber-200 p-4 rounded-xl flex gap-3"
            >
                <svg
                ...
                <div class="text-amber-800 text-xs leading-relaxed font-bold">
                    <p>
                        SUPERADMIN NOTE: Store names must be unique and
                        lowercase. Once created, a store's primary key path
